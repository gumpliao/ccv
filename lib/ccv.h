...
ccv_array_t* __attribute__((warn_unused_result)) ccv_dpm_sparse_detect_objects(ccv_dense_matrix_t* a, ccv_dpm_root_classifier_t* sparse_classifier, ccv_dense_matrix_t* alpha, ccv_dpm_mixture_model_t** models, int num_models, int model_index, ccv_dpm_param_t params);
